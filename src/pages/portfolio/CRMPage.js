          ...
          <div className="row">
            <div className="col-12 order-first">
              <div className="portfolio-thumb">
                <img src="../assets/img/portfolio/CRM_Banner.png" alt="Image" />
              </div>
            </div>
            ...
            <div className="col-lg-8">
              <div className="portfolio-details-content wow fadeInUp">
                <h2 className="portfolio-title">CRM</h2>
                <p className="mb-30">
                ...
                <div className="row">
                  <div className="col-sm-6">
                    <img
                      src="../assets/img/portfolio/CRM1.png"
                      alt="Image"
                      className="mb-30"
                    />
                  </div>
                  <div className="col-sm-6">
                    <img
                      src="../assets/img/portfolio/CRM2.png"
                      alt="Image"
                      className="mb-30"
                    />
                  </div>
